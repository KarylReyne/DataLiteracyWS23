...
Besides the demographic measures, the federal states plan their school budgets independently. The analysis of the adjusted budget to inflation per child has shown that it steadily increases for all federal states. Although, this may be caused by the increasing number of teachers and the goals of digitalization at schools (TODO source).
