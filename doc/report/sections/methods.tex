...
Although, there is a difference between old and new federal states in the evolution of full- and part-time teachers, as it is displayed in \autoref{fig:teacher_contracts}. In the new federal states are in average between 2004 and 2008 more part-time teachers than full-time. Instead, the old federal states have a nearly constant distribution of part-time teachers in average. Furthermore, they have since 2014 less employed full-time teachers than the new federal states. 
...
\begin{figure*}[ht]
    ...
    \caption{Relative number of teachers by contract type and federal states. The average ratio of full- (\textcolor{TUblue}{\rule[-0.2ex]{0.5em}{2pt} \rule[-0.2ex]{0.5em}{2pt}}) and part-time (\textcolor{TUred}{\rule[-0.2ex]{0.5em}{2pt} \rule[-0.2ex]{0.5em}{2pt}}) contracts of teachers is displayed its minimal and maximal bound for the old federal states (\emph{left}) and the new federal states (\emph{right}).}
