...
Importantly, the Abitur grades can only be analyzed for the average over all federal states, due to the missing representation. Nevertheless, the repeaters and budgets are analyzed for each federal state.
